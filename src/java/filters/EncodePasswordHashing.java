 ...
 * @author Admin
 */
public class EncodePasswordHashing implements Filter {
  ...
  PasswordHashing ph = new PasswordHashing();
    ...
    public EncodePasswordHashing() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("EncodePasswordHashing:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("EncodePasswordHashing:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("EncodePasswordHashing:doFilter()");
        }
	...
	// Create wrappers for the request and response objects.
        ...
        try {
            ...
            request.setAttribute("encoded", password);
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("EncodePasswordHashing: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("EncodePasswordHashing()");
        }
        StringBuffer sb = new StringBuffer("EncodePasswordHashing(");
	...
	// You might, for example, wish to add a setParameter() method. To do this
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("EncodePasswordHashing::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("EncodePasswordHashing::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("EncodePasswordHashing::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("EncodePasswordHashing::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("EncodePasswordHashing::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
